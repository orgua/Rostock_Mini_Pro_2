...
#define STRING_CONFIG_H_AUTHOR "orgua" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Delta Rostock Mini Pro 2"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "215e091c-32d8-4f91-ba96-754e1d7d5145"
...
//#define EXTRUDER_WATTS (12.0*12.0/4.0) //  P=I^2/R
//#define BED_WATTS (12.0*12.0/1.2)      // P=I^2/R // ORGUA TODO: P=U^2/R
...
#define  DEFAULT_bedKp 557.37
#define  DEFAULT_bedKi 109.03
#define  DEFAULT_bedKd 712.32
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 198.0 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 190.0 // mm
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER  12 // 42     // Z probe to nozzle X offset: -left  +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER  -7   // Z probe to nozzle Y offset: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -2.35  // Z probe to nozzle Z offset: -below (always!)
...
// extruder with gear: 32*200*5.18/(11.7*3.1415);
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {160, 160, 160, 902}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 451}  // default steps per unit for Kossel (GT2, 20 tooth)
